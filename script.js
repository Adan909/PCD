...
(function(){
    ...
    // cerrar cuando se selecciona un elemento del menú (delegación)
    menu.addEventListener('click', (e) => {
        const link = e.target.closest && e.target.closest('.menu-item');
        if(link){
            // allow normal navigation to other pages; close UI immediately
            close();
        }
    });
